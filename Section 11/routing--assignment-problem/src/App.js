		...
		return (
			<div className="App">
				...
				<ol style={{ textAlign: 'left' }}>
					...
					{/* <li>
						Make the courses in "Courses" clickable by adding a link
						and load the "Course" component in the place of
						"Courses" (without passing any data for now)
					</li> */}
					{/* <li>
						Pass the course ID to the "Course" page and output it
						there
					</li> */}
					<li>
						Pass the course title to the "Course" page - pass it as
						a param or score bonus points by passing it as query
